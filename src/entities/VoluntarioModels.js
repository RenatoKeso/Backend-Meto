...
const CapacidadFisica = sequelize.define(
  "CapacidadFisica",
  {
    id_capacidad_fisica: {
      type: DataTypes.INTEGER,
...
const UsuarioVoluntario = sequelize.define(
  "UsuarioVoluntario",
  {
    rut: {
...
const Cuadrilla = sequelize.define(
  "Cuadrilla",
  {
    id_cuadrilla: {
      type: DataTypes.INTEGER,
...
UsuarioVoluntario.belongsTo(CapacidadFisica, {
  foreignKey: "id_capacidad_fisica",
  as: "capacidad_fisica",
});
CapacidadFisica.hasOne(UsuarioVoluntario, {
  foreignKey: "id_capacidad_fisica",
});
...
Proyecto.belongsTo(UsuarioVoluntario, {
  foreignKey: "rut",
  as: "voluntario_asignado",
});
...
Reporte.belongsTo(UsuarioVoluntario, {
  foreignKey: "rut",
  as: "encargado_proyecto",
});
